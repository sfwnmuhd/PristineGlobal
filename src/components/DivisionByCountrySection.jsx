    ...
    <section className="py-20 px-6 bg-gray-50">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <motion.p
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          className="text:sm sm:text-lg text-gray-500 mb-12"
        >
        ...
        >
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-left">
              ...
              <p className="text-lg sm:text-2xl text-gray-500 leading-relaxed mb-8 whitespace-pre-line">
                {current.description}
              </p>
                ...
                <div>
                  <div className="flex items-center mb-4">
                    <ReactCountryFlag
                      ...
                      className="mr-4"
                    />
                    <h4 className="text-xl font-medium sm:text-2xl text-black">Upcoming Project</h4>
                  </div>
                  <p className="text-lg sm:text-2xl text-gray-500">{current.upcoming}</p>
                </div>
              )}
            </div>
          </div>
