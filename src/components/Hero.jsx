...
const Hero = () => {
  ...
  return (
    <section className="relative h-[80vh] sm:h-screen overflow-hidden bg-[#fafafa] flex flex-col pt-10 sm:pt-16" id='hero'>
      {/* ===== BACKGROUND GRID ===== */}
      <motion.div
      ...
      >
        ...
        >
          ...
          <motion.img
            ...
            className="w-full max-w-full max-h-[55vh] sm:max-h-[60vh] lg:max-h-[65vh] xl:max-h-[70vh] object-contain"
